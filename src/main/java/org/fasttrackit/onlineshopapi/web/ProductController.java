...
public class ProductController {
    ...
    //endpoint
    @GetMapping
    public ResponseEntity<Page<Product>> getProducts(GetProductRequest request, Pageable pageable){
        Page<Product> response = productService.getProduct(request, pageable);
